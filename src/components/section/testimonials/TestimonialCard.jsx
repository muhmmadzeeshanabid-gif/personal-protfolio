...
const TestimonialCard = ({ item }) => {
  return (
    <div className="group flex flex-col items-center p-6 sm:p-8 rounded-[20px] bg-primary-white shadow-[0_10px_30px_rgba(0,0,0,0.1)] transition-colors duration-75 hover:bg-primary-black hover:shadow-none cursor-default">
      <div className="relative mb-6">
        <div className="w-[80px] h-[80px] sm:w-[100px] sm:h-[100px] rounded-full overflow-hidden border-2 border-primary-black transition-colors duration-300 group-hover:border-primary-white">
          <img
            src={item.avatar}
            alt={item.name}
      ...
      <p className="text-center text-primary-black text-sm sm:text-base leading-relaxed mb-6 transition-colors duration-75 group-hover:text-primary-white">
        {item.content}
      </p>
