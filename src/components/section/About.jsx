...
import aboutMeImg from "../../assets/about-profile.jpeg";
          ...
          <div className="flex-1 space-y-8 relative pt-4 lg:pt-0">
            ...
            <div className="space-y-6 text-zinc-500 text-sm md:text-base leading-relaxed">
              ...
              <p>
                ...
                expertise in HTML, CSS, JavaScript (ES6+), TypeScript, React, Next.js,
                and Tailwind CSS, specializing in seamless API integrations (RESTful,
                serverless endpoints, Gemini AI API, Stripe payments) and modern backends
                like Firebase and Supabase.
              </p>
              <p>
